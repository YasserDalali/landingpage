...
export default function Hero() {
  const perks = ["Unlimited talk and text", "Unlimited data", "Cancel anytime"];
  return (
    <article className="flex flex-col items-center p-whitespacex">
      ...
      <div className="p-whitespace text-xl">
        {perks.map((perk, index) => (
          <div key={index} className="flex items-center mb-2 font-serif">
            {perk}
          </div>
        ))}
      </div>
