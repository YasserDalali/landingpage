...
export default function Cta() {
  return (
    <div className="p-whitespacey md:p-whitespacex w-full">
      <section className="p-14 bg-gradient-to-tr from-blue-100 to-indigo-100 rounded-t-xl">
        <h1 className="text-4xl font-semibold text-center">Get connected in 72 seconds</h1>
      ...
      <section className="pt-14 relative text-white bg-gradient-to-tr from-primary to-black rounded-xl -translate-y-4">
        <h3 className="text-4xl md:text-6xl font-semibold text-center">One plan, <br /> one price.</h3>
        <h2 className="text-6xl md:text-8xl font-semibold text-center my-7">$69</h2>
